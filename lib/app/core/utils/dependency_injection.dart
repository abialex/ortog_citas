...
import '../../data/provider/api/remote/cita_api.dart';
...
import '../../data/provider/api/remote/paciente_api.dart';
import '../../data/provider/api/remote/persona_api.dart';
...
import '../../data/repository_imp/remote/doctor_repository.dart';
import '../../data/repository_imp/remote/handle_firebase_repository.dart';
import '../../data/repository_imp/remote/paciente_repository.dart';
...
class DependencyInjection {
  static Future<void> init() async {
    ...
    Get.lazyPut<Dio>(
      () => Dio(
        BaseOptions(
          baseUrl: 'http://147.182.205.111:2500',
