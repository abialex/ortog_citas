...
import 'package:ortog_citas/app/ui/modules/cita/cita_list/controller.dart';
                  ...
                  if (controller.loginIconState.value == ProgressState.oculto) {
                    return Visibility(
                      ...
                      child: ListView.builder(
                        ...
                        shrinkWrap: true,
                        itemCount: _.carritoController.listItems.length,
                        itemBuilder: (BuildContext context, int index) {
                          return Obx(() {
                            late Widget card;
                            if (_.carritoController.listItems[index].isLibre) {
                              card = CustomCardCitaLibre(
                                onAddCitaOcupada: _.agregarCitaOcupada,
                                onChanged: _.gotoCitaCreate,
                                itemHoraModel:
                                    _.carritoController.listItems[index],
                              );
                            } else {
                              if (_.carritoController.listItems[index]
                                  .isOcupado) {
                                ...
                                card = CustomCardCita(
                                  onUpdateCita: _.gotoPacienteCreateFromCita,
