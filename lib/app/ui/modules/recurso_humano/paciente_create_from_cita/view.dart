...
class PacienteCreateFromCitaPage
    extends GetWidget<PacienteCreateFromCitaController> {
              ...
              children: [
                Container(
                  decoration: BoxDecoration(
                    border: Border.all(color: OrtognaticaColors.greyWhite),
                  ),
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ConsultaSunatPage(
                            onPressed:
                                _.getPersonaSunat, //QUE HAGO CON LOQUE RECIBO,
                          ),
                          Row(
